            ...
            <div className="flex flex-wrap gap-1.5 mb-3">
              {client.semSite ? (
                ...
                <a
                  ...
                  className={`text-[11px] px-2 py-0.5 rounded-md bg-success/10 border border-success/25 text-green-300 inline-flex items-center gap-1 ${client.siteUrl ? 'hover:bg-success/20 transition-colors' : 'pointer-events-none'}`}
                >
                  ✅ {client.siteUrl ? 'Tem site ↗' : 'Tem site'}
                </a>
              )}

              {/* Instagram — sempre mostra para leads reais como busca */}
              <a
              ...
              >
                ...
                {client.instagramAtivo ? 'Instagram ↗' : 'Buscar Instagram ↗'}
              </a>
              ...
              {client.googleMaps && (
                ...
                >
                  ...
                  Maps {client.avaliacoes > 0 ? `(${client.avaliacoes} av.) ` : ''}↗
                </a>
              )}
            </div>
              ...
              <div className="flex gap-2">
                {client.instagramUrl && (
                  ...
                  >
                    ...
                    {client.instagramAtivo ? 'Abrir Instagram ↗' : 'Buscar Instagram ↗'}
                  </a>
                )}
